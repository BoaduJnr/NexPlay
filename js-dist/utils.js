...
var UX = function () {
  ...
  function fetchInAppRatings(ids) {
    ...
    var base = h === 'localhost' || h === '127.0.0.1' || window.location.protocol === 'https:' ? '' : typeof Config !== 'undefined' && Config.DEPLOY_URL ? Config.DEPLOY_URL : '';
  ...
  return {
    ...
    fetchInAppRatings: fetchInAppRatings
  };
}();