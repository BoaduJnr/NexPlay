...
var StreamResolver = (function() {
  ...
  function resolveMovie(tmdbId, title, year) {
    ...
    var step1 = _isTV
      ? resolveVidrock(tmdbId, 'movie', null, null)
      : resolveVideasy(tmdbId, 'movie', title, year, null, null);
    var step2 = _isTV
      ? function() { return resolveVideasy(tmdbId, 'movie', title, year, null, null); }
      : function() { return resolveVidrock(tmdbId, 'movie', null, null); };
  ...
  function resolveTVEpisode(tmdbId, title, season, episode) {
    ...
    var step1 = _isTV
      ? resolveVidrock(tmdbId, 'tv', season, episode)
      : resolveVideasy(tmdbId, 'tv', title, null, season, episode);
    var step2 = _isTV
      ? function() { return resolveVideasy(tmdbId, 'tv', title, null, season, episode); }
      : function() { return resolveVidrock(tmdbId, 'tv', season, episode); };
